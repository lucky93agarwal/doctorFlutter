...
import 'package:drapplist/utils/config.dart';
...
class ThemeModel {
  final lightTheme = ThemeData(
    ...
    textTheme: TextTheme(
      headline1: TextStyle(color: Colors.white, fontSize: 12,letterSpacing: 1.0, fontWeight: FontWeight.w900),
      headline2: TextStyle(color: Colors.white, fontSize: 18,letterSpacing: 1.0, fontWeight: FontWeight.w900),
      headline3: TextStyle(color: Color(0xff747376), fontSize: 18,letterSpacing: 1.0, fontWeight: FontWeight.w900),
      headline4: TextStyle(color: Color(0xff28272c), fontSize: 15,letterSpacing: 1.0, fontWeight: FontWeight.w900),
